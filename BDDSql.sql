...
CREATE INDEX `fk_StatutLivreur_Utilisateur1_idx` ON `expressFood`.`InformationLivreur` (`Utilisateur_idUtilisateur` ASC) ;
...
CREATE INDEX `fk_Commande_has_Plat_Plat1_idx` ON `expressFood`.`CommandePlat` (`Plat_idPlat` ASC) ;

CREATE INDEX `fk_Commande_has_Plat_Commande1_idx` ON `expressFood`.`CommandePlat` (`Commande_idCommande` ASC) ;
